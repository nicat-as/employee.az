    ...
    <ul class="nav nav-pills">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="#"><img class="w20 mr-2" src="assets/images/flags/az.svg">Azerbaijan</a>
                <a class="dropdown-item" href="#"><img class="w20 mr-2" src="assets/images/flags/ru.svg">Russia</a>
                <a class="dropdown-item" href="#"><img class="w20 mr-2" src="assets/images/flags/tr.svg">Turkey</a>
            </div>
        </li>
        <li class="nav-item dropdown">
