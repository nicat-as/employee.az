                                        ...
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <ul class="social-links list-inline mb-0 mt-2">
                                                    ...
                                                    <li class="list-inline-item"><a href="javascript:void(0)" title=""
                                                                                    data-toggle="tooltip"
                                                                                    data-original-title="1234567890"><i
                                                            class="fa fa-phone"></i></a></li>
                                                    <li class="list-inline-item"><a href="javascript:void(0)" title=""
                                                                                    data-toggle="tooltip"
                                                                                    data-original-title="@skypename"><i
                                                            class="fa fa-skype"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <p class="mb-4">Contrary to popular belief, Lorem Ipsum is not simply random
                                            text. It has roots in a piece of classical Latin literature from 45 BC,
                                            making it over 2000 years old.</p>
                                        <button class="btn btn-outline-primary btn-sm"><span
                                                class="fa fa-twitter"></span> Follow
                                        </button>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-0">
                                            <label class="d-block">Photoshop <span
                                                    class="float-right">23%</span></label>
                                            <div class="progress progress-xs">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Archive Job</h4>
            </div>
            <div class="modal-body">
                <div class="modal-body" style="font-size:  larger">
                    Position : <span style="font-size: large" id="position"></span> <br>
                    Name :<span style="font-size: large" id="userName"></span> <br>
                    About :<span style="font-size: large" id="about"></span> <br>
                    Requirement :<span style="font-size: large" id="requirement"></span> <br>
                    Minimal Salary :<span style="font-size: large" id="salaryMin"></span> <br>
                    Maximal Salary :<span style="font-size: large" id="salaryMax"></span> <br>
                    Post Date : <span style="font-size: large" id="postDate"></span> <br>
                    Deadline :<span style="font-size: large" id="deadline"></span> <br>
                    Country Name :<span style="font-size: large" id="countryName"></span> <br>
                    City Name :<span style="font-size: large" id="cityName"></span> <br>
                    Job Type :<span style="font-size: large" id="jobType"></span> <br>
                    Experience Minimum :<span style="font-size: large" id="experienceMin"></span> <br>
                    Experience Maximum :<span style="font-size: large" id="experienceMax"></span> <br>
                    Job Category :<span style="font-size: large" id="jobCategory"></span> <br>
                    Company :<span style="font-size: large" id="organizationName"></span> <br>
                    Premium :<span style="font-size: large" id="premium"></span> <br>
                </div>
            </div>
    ...
    function  showDetail(button) {
        ...
        $.ajax( {
            ...
            success: function(serverResponse) {
                ...
                document.getElementById("position").innerHTML = serverResponse.position;
                document.getElementById("userName").innerHTML = serverResponse.userName;
                document.getElementById("about").innerHTML = serverResponse.about;
                document.getElementById("requirement").innerHTML = serverResponse.requirement;
                document.getElementById("salaryMin").innerHTML = serverResponse.salaryMin;
                document.getElementById("salaryMax").innerHTML = serverResponse.salaryMax;
                document.getElementById("postDate").innerHTML = serverResponse.postDate;
                document.getElementById("deadline").innerHTML = serverResponse.deadline;
                document.getElementById("countryName").innerHTML = serverResponse.countryName;
                document.getElementById("cityName").innerHTML = serverResponse.cityName;
                document.getElementById("jobType").innerHTML = serverResponse.jobType;
                document.getElementById("experienceMin").innerHTML = serverResponse.experienceMin;
                document.getElementById("experienceMax").innerHTML = serverResponse.experienceMax;
                document.getElementById("jobCategory").innerHTML = serverResponse.jobCategory;
                document.getElementById("organizationName").innerHTML = serverResponse.organizationName;
                document.getElementById("premium").innerHTML = serverResponse.premium;
            }
        })
    }
