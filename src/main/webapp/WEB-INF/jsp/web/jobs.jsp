                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                            <h4>${jl.position}</h4>
                                                            <p>${jl.organization.name}</p>
                                                            <ul>
                                                                <li><i class="fa fa-cc-paypal"></i>&nbsp; ${jl.minSalary} - ${jl.maxSalary}</li>
                                                                <li><i class="fa fa-map-marker"></i>&nbsp;${jl.address.country.name},${jl.address.city.name}</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                            <ul>
                                                                ...
                                                                <li><a>${jl.type.name()}</a></li>
                                                                <li><a href="jobView?id=${jl.id}">Apply</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <ul class="pagination">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${currentPage <= pageCount}">
                                                        <li><a href="jobs?page=${currentPage - 1}">Prev.</a></li>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <li><a href="#">Prev.</a></li>
                                                    </c:otherwise>
                                                ...
                                                <c:forEach begin="1" end="${pageCount}" var="pg">
                                                    <c:choose>
                                                        <c:when test="${currentPage == pg}">
                                                            <li class="active"><a href="jobs?page=${pg}">${pg}</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li><a href="jobs?page=${pg}">${pg}</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:when test="${currentPage < pageCount}">
                                                        <li><a href="jobs?page=${currentPage + 1}">Next</a></li>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <li><a href="#">Next</a></li>
                                                    </c:otherwise>
