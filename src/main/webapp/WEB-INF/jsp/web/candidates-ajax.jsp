        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="jp_listing_heading_wrapper">
                    <h2>We found <span id="candidate_count">0</span> Matches for you.</h2>
                </div>
            </div>
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                <div class="gc_causes_search_box_wrapper gc_causes_search_box_wrapper2">
                                    <div class="gc_causes_search_box">
                                        <p>You're Watching &nbsp;<span id="data_range">1-20</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="tab-content">
                            <div id="grid" class="tab-pane fade in active">
                                <div class="row">
                                    <div id="candidate_grid">
                                    </div>
    <!-- todo paging -->
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                                        <div class="pager_wrapper gc_blog_pagination">
                                            <select id="candidate_grid_paging" class="selectpicker" data-live-search="true">
                                            </select>
<%--                                            <ul class="pagination">--%>
...
<script src="/js/employeeaz/common.js"></script>
<script src="/js/employeeaz/web.js"></script>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: getBaseUrl() + "rest/candidates/",
            data: {
                page: 1,
                size: 12
            },
            success: function (response) {
                ...
                $('#candidate_count').html(response.totalCount);
                $('#data_range').html(response.currentPage + "/" + response.pageCount);
                ...
                for(i = 1; i<= response.pageCount; i++) {
                    ...
                    if(response.currentPage == i) {
                        console.log('if ' + i);
                        o = new Option("Page " + i, i, true, true);
                    } else {
                        console.log('else ' + i);
                        o = new Option("Page " + i, i);
                    }

                    /// jquerify the DOM object 'o' so we can use the html method
                    // $(o).html("option text");
                    $("#candidate_grid_paging").append(o);
                }
                ...
                for(i = 0; i < response.data.length; i++) {
                    console.log(response.data[i].id + ' '
                        ...
                        + response.data[i].user.surname
                    );

                    $('#candidate_grid').append(' <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">\n' +
                        ...
                        '                                                                <h4>' + response.data[i].user.name + '&nbsp;' + response.data[i].user.surname + '</h4>\n' +
                        '                                                                <p>' + response.data[i].position + '</p>\n' +
                        '                                                                <ul>\n' +
                        '                                                                    <li><i class="fa fa-cc-paypal"></i>&nbsp;' + response.data[i].salaryMin + ' - ' + response.data[i].salaryMax + '</li>\n' +
                        '                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; ' + response.data[i].address.country.name + '&nbsp; ' + response.data[i].address.city.name + '</li>\n' +
                        '                                                                </ul>\n' +
                        '                                                            </div>\n' +
                        '                                                        </div>\n' +
                        '                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n' +
                        ...
                        '                                                                    <li><a href="candidate?id=' + response.data[i].id + '">View</a></li>\n' +
                        '                                                                </ul>\n' +
                        '                                                            </div>\n' +
                        '                                                        </div>\n' +
                        '                                                    </div>\n' +
                    ...
                    $('#candidate_list').append('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n' +
                        '                                        <div class="jp_job_post_main_wrapper_cont jp_job_post_grid_main_wrapper_cont">\n' +
                        ...
                        '                                                            <ul>\n' +
                        '                                                                <li><i class="fa fa-cc-paypal"></i>&nbsp; ' + response.data[i].salaryMin + ' - ' + response.data[i].salaryMax +'</li>\n' +
                        '                                                                <li><i class="fa fa-map-marker"></i>&nbsp; ' + response.data[i].address.country.name + ' ' + response.data[i].address.city.name + ' ' + response.data[i].address.info + '</li>\n' +
                        '                                                            </ul>\n' +
                        '                                                        </div>\n' +
                        '                                                    </div>\n' +
                        '                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">\n' +
