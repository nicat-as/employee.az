...
<%--                                                            <ul>--%>
<%--                                                                <li><i class="fa fa-map-marker"></i>&nbsp; ${company.address.country.name}, ${company.address.city.name}</li>--%>
<%--                                                            </ul>--%>
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper jp_cl_aply_btn">
                                                                <ul>
                                                                    <li><a>${company.count} active jobs</a></li>
                                                                </ul>
                                                            </div>
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper jp_cl_aply_btn">
                                                                <ul>
                                                                    <li><a href="company?id=${company.id}">View</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <ul class="pagination">
                                                <c:choose>
                                                    ...
                                                    <c:when test="${currentPage <= pageCount}">
                                                        <li><a href="companies?page=${currentPage - 1}">Priv.</a></li>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <li><a href="#">Priv.</a></li>
                                                    </c:otherwise>
                                                ...
                                                <c:forEach begin="1" end="${pageCount}" var="pg">
                                                    <c:choose>
                                                        <c:when test="${currentPage == pg}">
                                                            <li class="active"><a href="companies?page=${pg}">${pg}</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li><a href="companies?page=${pg}">${pg}</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:when test="${currentPage < pageCount}">
                                                        <li><a href="companies?page=${currentPage + 1}">Next</a></li>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <li><a href="#">Next</a></li>
                                                    </c:otherwise>
...
<%--                                                            </ul>--%>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="jp_job_post_right_btn_wrapper">
                                                            <ul>
                                                                <li><a href="company.jsp">${company.count} ACTIVE JOBS</a></li>
                                                            </ul>
                                                            <ul>
                                                                <li><a href="company?id=${company.id}">View</a></li>
                                                            </ul>
                                        ...
                                        <div class="pager_wrapper gc_blog_pagination">
                                            <ul class="pagination">
                                                ...
                                                <c:forEach begin="1" end="${pageCount}" var="pc">
                                                    <c:choose>
                                                        <c:when test="${currentPage == pc}">
                                                            <li class="active"><a href="companies?page=${pc}">${pc}</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li><a href="companies?page=${pc}">${pc}</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
