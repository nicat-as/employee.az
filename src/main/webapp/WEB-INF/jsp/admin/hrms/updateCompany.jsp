                    ...
                    <div role="tabpanel">
                        ...
                        <div class="tab-content">
                            ...
                            <div  class="tab-pane fade in active register_left_form" id="contentOne-2">
                                <form:form modelAttribute="companyRegistrationForm" action="updateCompany" method="post">
                                ...
                                <div class="login_btn_wrapper register_btn_wrapper login_wrapper ">
                                    <input type="submit" href="addCompany"  value="  Update " class="btn btn-primary login_btn"/>
                                </div>
                                    </form:form>
                            </div>
