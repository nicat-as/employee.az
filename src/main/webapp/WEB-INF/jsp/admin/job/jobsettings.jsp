...
<!-- Mirrored from puffintheme.com/demo/epic/hr/laravel/public/job/jobsettings by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Oct 2019 15:18:38 GMT -->
...
<title>job Settings - Laravel</title>
        ...
        <ul class="metismenu">
            ...
            <li class="active">
                ...
                <ul>
                    ...
                    <li class="active"><a href="jobsettings.jsp">Settings</a></li>
                </ul>
            </li>
            <li class="">
